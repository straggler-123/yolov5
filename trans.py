...
if __name__ == '__main__':
    VOC2Yolo(
        class_num={'red_cone': 0, 'blue_cone': 1, 'yellow_cone': 2, 'yellow_cone_high': 3},  # 标签种类
        voc_img_path=r'C:\Users\19815\Desktop\JPEGImages\JPEGImages', # 数据集图片文件夹存储路径
        voc_xml_path=r'C:\Users\19815\Desktop\Annotations\Annotations', # 标签xml文件夹存储路径
        yolo_txt_save_path=r'C:\Users\19815\Desktop\atxt' # 将要生成的txt文件夹存储路径
    )
